...
class Orca < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/vanthaita/Orca-CLI/releases/download/v0.1.14/orca-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/vanthaita/Orca-CLI/releases/download/v0.1.14/orca-x86_64-unknown-linux-gnu.tar.gz"
